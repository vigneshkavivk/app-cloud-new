...
export class ExpressRouteCircuitConnectionsImpl {
    ...
    async *listPagingPage(resourceGroupName, circuitName, peeringName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, circuitName, peeringName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, circuitName, peeringName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, circuitName, peeringName, options)) {
            yield* page;
        }
    }
    /**
