...
export class PrivateEndpointsImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, privateEndpointName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, privateEndpointName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, privateEndpointName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, privateEndpointName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, privateEndpointName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     * Gets all private endpoints in a resource group.
