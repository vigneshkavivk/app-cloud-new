...
export class StaticMembersImpl {
    ...
    async *listPagingPage(resourceGroupName, networkManagerName, networkGroupName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, networkManagerName, networkGroupName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, networkManagerName, networkGroupName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, networkManagerName, networkGroupName, options)) {
            yield* page;
        }
    }
    /**
