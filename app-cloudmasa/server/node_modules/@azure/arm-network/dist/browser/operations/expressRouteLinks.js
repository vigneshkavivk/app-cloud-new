...
export class ExpressRouteLinksImpl {
    ...
    async *listPagingPage(resourceGroupName, expressRoutePortName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, expressRoutePortName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, expressRoutePortName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, expressRoutePortName, options)) {
            yield* page;
        }
    }
    /**
