...
export class FirewallPolicyRuleCollectionGroupsImpl {
    ...
    async *listPagingPage(resourceGroupName, firewallPolicyName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, firewallPolicyName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, firewallPolicyName, options) {
