...
export class NetworkVirtualApplianceConnectionsImpl {
    ...
    async *listPagingPage(resourceGroupName, networkVirtualApplianceName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, networkVirtualApplianceName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, networkVirtualApplianceName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, networkVirtualApplianceName, options)) {
            yield* page;
        }
    }
    /**
