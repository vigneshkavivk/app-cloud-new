...
export class VpnLinkConnectionsImpl {
    ...
    async *getAllSharedKeysPagingPage(resourceGroupName, gatewayName, connectionName, linkConnectionName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._getAllSharedKeys(resourceGroupName, gatewayName, connectionName, linkConnectionName, options);
        ...
        while (continuationToken) {
            result = await this._getAllSharedKeysNext(resourceGroupName, gatewayName, connectionName, linkConnectionName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *getAllSharedKeysPagingAll(resourceGroupName, gatewayName, connectionName, linkConnectionName, options) {
        for await (const page of this.getAllSharedKeysPagingPage(resourceGroupName, gatewayName, connectionName, linkConnectionName, options)) {
            yield* page;
        }
    }
    /**
    ...
    async *listByVpnConnectionPagingPage(resourceGroupName, gatewayName, connectionName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._listByVpnConnection(resourceGroupName, gatewayName, connectionName, options);
            const page = result.value || [];
            continuationToken = result.nextLink;
            setContinuationToken(page, continuationToken);
            yield page;
        ...
        while (continuationToken) {
            result = await this._listByVpnConnectionNext(resourceGroupName, gatewayName, connectionName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listByVpnConnectionPagingAll(resourceGroupName, gatewayName, connectionName, options) {
        for await (const page of this.listByVpnConnectionPagingPage(resourceGroupName, gatewayName, connectionName, options)) {
            yield* page;
        }
    }
    /**
