...
export class VirtualHubBgpConnectionsImpl {
     ...
     * @param options The options parameters.
     */
    async beginListLearnedRoutes(resourceGroupName, hubName, connectionName, options) {
     ...
     * @param options The options parameters.
     */
    async beginListLearnedRoutesAndWait(resourceGroupName, hubName, connectionName, options) {
        const poller = await this.beginListLearnedRoutes(resourceGroupName, hubName, connectionName, options);
     ...
     * @param options The options parameters.
     */
    async beginListAdvertisedRoutes(resourceGroupName, hubName, connectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginListAdvertisedRoutesAndWait(resourceGroupName, hubName, connectionName, options) {
        const poller = await this.beginListAdvertisedRoutes(resourceGroupName, hubName, connectionName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
