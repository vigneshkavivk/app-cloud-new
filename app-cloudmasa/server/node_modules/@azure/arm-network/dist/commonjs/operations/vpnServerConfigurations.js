...
class VpnServerConfigurationsImpl {
     ...
     * @param options The options parameters.
     */
    listRadiusSecrets(resourceGroupName, vpnServerConfigurationName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, vpnServerConfigurationName, options }, listRadiusSecretsOperationSpec);
    }
    /**
