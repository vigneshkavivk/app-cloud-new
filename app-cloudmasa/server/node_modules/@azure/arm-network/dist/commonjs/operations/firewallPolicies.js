...
exports.FirewallPoliciesImpl = void 0;
...
class FirewallPoliciesImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, firewallPolicyName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, firewallPolicyName, options) {
        const poller = await this.beginDelete(resourceGroupName, firewallPolicyName, options);
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, firewallPolicyName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, firewallPolicyName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, firewallPolicyName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.FirewallPoliciesImpl = FirewallPoliciesImpl;
