...
exports.VirtualNetworkPeeringsImpl = void 0;
...
class VirtualNetworkPeeringsImpl {
    ...
    async *listPagingPage(resourceGroupName, virtualNetworkName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, virtualNetworkName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, virtualNetworkName, options) {
...
exports.VirtualNetworkPeeringsImpl = VirtualNetworkPeeringsImpl;
