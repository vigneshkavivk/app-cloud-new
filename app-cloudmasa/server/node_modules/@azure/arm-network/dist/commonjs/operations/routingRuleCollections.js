...
exports.RoutingRuleCollectionsImpl = void 0;
...
class RoutingRuleCollectionsImpl {
    client;
    /**
    ...
    async *listPagingPage(resourceGroupName, networkManagerName, configurationName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, networkManagerName, configurationName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, networkManagerName, configurationName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, networkManagerName, configurationName, options)) {
            yield* page;
        }
    }
    /**
...
exports.RoutingRuleCollectionsImpl = RoutingRuleCollectionsImpl;
