...
exports.AvailablePrivateEndpointTypesImpl = void 0;
...
class AvailablePrivateEndpointTypesImpl {
    ...
    async *listByResourceGroupPagingPage(location, resourceGroupName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listByResourceGroupNext(location, resourceGroupName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByResourceGroupPagingAll(location, resourceGroupName, options) {
        for await (const page of this.listByResourceGroupPagingPage(location, resourceGroupName, options)) {
            yield* page;
        }
    }
    /**
...
exports.AvailablePrivateEndpointTypesImpl = AvailablePrivateEndpointTypesImpl;
