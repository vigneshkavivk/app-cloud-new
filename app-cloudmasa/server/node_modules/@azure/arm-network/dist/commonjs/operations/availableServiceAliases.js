...
exports.AvailableServiceAliasesImpl = void 0;
...
class AvailableServiceAliasesImpl {
    ...
    async *listByResourceGroupPagingPage(resourceGroupName, location, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listByResourceGroupNext(resourceGroupName, location, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByResourceGroupPagingAll(resourceGroupName, location, options) {
        for await (const page of this.listByResourceGroupPagingPage(resourceGroupName, location, options)) {
            yield* page;
        }
    }
    /**
...
exports.AvailableServiceAliasesImpl = AvailableServiceAliasesImpl;
