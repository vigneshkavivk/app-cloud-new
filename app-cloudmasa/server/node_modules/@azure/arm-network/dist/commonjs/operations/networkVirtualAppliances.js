...
exports.NetworkVirtualAppliancesImpl = void 0;
...
class NetworkVirtualAppliancesImpl {
     ...
     * @param options The options parameters.
     */
    async beginReimage(resourceGroupName, networkVirtualApplianceName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginReimageAndWait(resourceGroupName, networkVirtualApplianceName, options) {
     ...
     * @param options The options parameters.
     */
    async beginGetBootDiagnosticLogs(resourceGroupName, networkVirtualApplianceName, request, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetBootDiagnosticLogsAndWait(resourceGroupName, networkVirtualApplianceName, request, options) {
        const poller = await this.beginGetBootDiagnosticLogs(resourceGroupName, networkVirtualApplianceName, request, options);
        return poller.pollUntilDone();
    }
    /**
     * Lists all Network Virtual Appliances in a resource group.
...
exports.NetworkVirtualAppliancesImpl = NetworkVirtualAppliancesImpl;
...
const getBootDiagnosticLogsOperationSpec = {
