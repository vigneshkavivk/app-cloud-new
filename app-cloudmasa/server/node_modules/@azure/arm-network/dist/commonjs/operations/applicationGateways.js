...
exports.ApplicationGatewaysImpl = void 0;
...
class ApplicationGatewaysImpl {
    ...
    async *listAvailableSslPredefinedPoliciesPagingPage(options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listAvailableSslPredefinedPoliciesNext(continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listAvailableSslPredefinedPoliciesPagingAll(options) {
        for await (const page of this.listAvailableSslPredefinedPoliciesPagingPage(options)) {
            yield* page;
        }
    }
    /**
...
exports.ApplicationGatewaysImpl = ApplicationGatewaysImpl;
...
const getSslPredefinedPolicyOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion],
    urlParameters: [Parameters.$host, Parameters.subscriptionId, Parameters.predefinedPolicyName],
    headerParameters: [Parameters.accept],
    serializer,
};
