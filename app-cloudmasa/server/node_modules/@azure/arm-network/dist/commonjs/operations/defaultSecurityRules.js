...
class DefaultSecurityRulesImpl {
    ...
    async *listPagingPage(resourceGroupName, networkSecurityGroupName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, networkSecurityGroupName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, networkSecurityGroupName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, networkSecurityGroupName, options)) {
            yield* page;
        }
    }
    /**
