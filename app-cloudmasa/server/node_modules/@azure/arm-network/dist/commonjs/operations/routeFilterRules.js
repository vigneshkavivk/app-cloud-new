...
exports.RouteFilterRulesImpl = void 0;
...
class RouteFilterRulesImpl {
    ...
    async *listByRouteFilterPagingPage(resourceGroupName, routeFilterName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listByRouteFilterNext(resourceGroupName, routeFilterName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByRouteFilterPagingAll(resourceGroupName, routeFilterName, options) {
        for await (const page of this.listByRouteFilterPagingPage(resourceGroupName, routeFilterName, options)) {
            yield* page;
        }
    }
    /**
...
exports.RouteFilterRulesImpl = RouteFilterRulesImpl;
