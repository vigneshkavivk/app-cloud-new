...
exports.LoadBalancerNetworkInterfacesImpl = void 0;
...
class LoadBalancerNetworkInterfacesImpl {
    ...
    async *listPagingPage(resourceGroupName, loadBalancerName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, loadBalancerName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, loadBalancerName, options) {
...
exports.LoadBalancerNetworkInterfacesImpl = LoadBalancerNetworkInterfacesImpl;
