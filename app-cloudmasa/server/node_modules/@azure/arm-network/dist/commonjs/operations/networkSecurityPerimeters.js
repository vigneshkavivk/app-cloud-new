...
exports.NetworkSecurityPerimetersImpl = void 0;
...
class NetworkSecurityPerimetersImpl {
    client;
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, networkSecurityPerimeterName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, networkSecurityPerimeterName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createOrUpdate(resourceGroupName, networkSecurityPerimeterName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, networkSecurityPerimeterName, parameters, options }, createOrUpdateOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, networkSecurityPerimeterName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, networkSecurityPerimeterName, options) {
     ...
     * @param options The options parameters.
     */
    patch(resourceGroupName, networkSecurityPerimeterName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, networkSecurityPerimeterName, parameters, options }, patchOperationSpec);
    }
    /**
     * List all network security perimeters in a subscription.
     * @param options The options parameters.
...
exports.NetworkSecurityPerimetersImpl = NetworkSecurityPerimetersImpl;
...
//# sourceMappingURL=networkSecurityPerimeters.js.map