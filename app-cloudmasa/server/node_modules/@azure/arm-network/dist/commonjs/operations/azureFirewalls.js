...
class AzureFirewallsImpl {
     ...
     * @param options The options parameters.
     */
    async beginPacketCaptureOperation(resourceGroupName, azureFirewallName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
        ...
        const lro = (0, lroImpl_js_1.createLroSpec)({
            sendOperationFn,
            args: { resourceGroupName, azureFirewallName, parameters, options },
            spec: packetCaptureOperationOperationSpec,
        });
        const poller = await (0, core_lro_1.createHttpPoller)(lro, {
            restoreFrom: options?.resumeFrom,
            intervalInMs: options?.updateIntervalInMs,
     ...
     * @param options The options parameters.
     */
    async beginPacketCaptureOperationAndWait(resourceGroupName, azureFirewallName, parameters, options) {
        const poller = await this.beginPacketCaptureOperation(resourceGroupName, azureFirewallName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
const packetCaptureOperationOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: Mappers.AzureFirewallPacketCaptureResponse,
        },
        201: {
            bodyMapper: Mappers.AzureFirewallPacketCaptureResponse,
        },
