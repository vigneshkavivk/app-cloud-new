...
class ApplicationGatewayPrivateEndpointConnectionsImpl {
    ...
    async *listPagingPage(resourceGroupName, applicationGatewayName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, applicationGatewayName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, applicationGatewayName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, applicationGatewayName, options)) {
            yield* page;
        }
    }
    /**
