...
exports.ExpressRouteCircuitAuthorizationsImpl = void 0;
...
class ExpressRouteCircuitAuthorizationsImpl {
    ...
    async *listPagingPage(resourceGroupName, circuitName, options, settings) {
        let result;
    ...
    async *listPagingAll(resourceGroupName, circuitName, options) {
...
exports.ExpressRouteCircuitAuthorizationsImpl = ExpressRouteCircuitAuthorizationsImpl;
