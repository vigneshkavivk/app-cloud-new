...
exports.NetworkInterfaceTapConfigurationsImpl = void 0;
...
class NetworkInterfaceTapConfigurationsImpl {
    ...
    async *listPagingPage(resourceGroupName, networkInterfaceName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, networkInterfaceName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, networkInterfaceName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, networkInterfaceName, options)) {
            yield* page;
        }
    }
    /**
...
exports.NetworkInterfaceTapConfigurationsImpl = NetworkInterfaceTapConfigurationsImpl;
