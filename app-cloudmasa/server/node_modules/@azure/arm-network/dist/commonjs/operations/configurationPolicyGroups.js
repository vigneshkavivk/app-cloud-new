...
exports.ConfigurationPolicyGroupsImpl = void 0;
...
class ConfigurationPolicyGroupsImpl {
    ...
    async *listByVpnServerConfigurationPagingPage(resourceGroupName, vpnServerConfigurationName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._listByVpnServerConfiguration(resourceGroupName, vpnServerConfigurationName, options);
        ...
        while (continuationToken) {
            result = await this._listByVpnServerConfigurationNext(resourceGroupName, vpnServerConfigurationName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByVpnServerConfigurationPagingAll(resourceGroupName, vpnServerConfigurationName, options) {
        for await (const page of this.listByVpnServerConfigurationPagingPage(resourceGroupName, vpnServerConfigurationName, options)) {
            yield* page;
        }
    }
    /**
...
exports.ConfigurationPolicyGroupsImpl = ConfigurationPolicyGroupsImpl;
