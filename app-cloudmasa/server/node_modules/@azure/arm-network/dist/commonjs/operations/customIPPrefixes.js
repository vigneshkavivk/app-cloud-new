...
exports.CustomIPPrefixesImpl = void 0;
...
class CustomIPPrefixesImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, customIpPrefixName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, customIpPrefixName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, customIpPrefixName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, customIpPrefixName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, customIpPrefixName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.CustomIPPrefixesImpl = CustomIPPrefixesImpl;
