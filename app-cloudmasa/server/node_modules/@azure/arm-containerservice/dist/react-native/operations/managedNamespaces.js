...
export class ManagedNamespacesImpl {
    client;
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, resourceName, managedNamespaceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, resourceName, managedNamespaceName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, resourceName, managedNamespaceName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, resourceName, managedNamespaceName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, resourceName, managedNamespaceName, parameters, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, resourceName, managedNamespaceName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, resourceName, managedNamespaceName, options) {
        const poller = await this.beginDelete(resourceGroupName, resourceName, managedNamespaceName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    update(resourceGroupName, resourceName, managedNamespaceName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    listCredential(resourceGroupName, resourceName, managedNamespaceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, resourceName, managedNamespaceName, options }, listCredentialOperationSpec);
    }
    /**
...
const listCredentialOperationSpec = {
