 ...
 * **Ubuntu2404**: Use Ubuntu2404 as the OS for node images, however, Ubuntu 24.04 may not be supported for all nodepools. For limitations and supported kubernetes versions, see https:\/\/aka.ms\/aks\/supported-ubuntu-versions
 */
...
export declare enum KnownLocalDNSMode {
...
export declare enum KnownLocalDNSState {
    /** localDNS is enabled. */
    Enabled = "Enabled",
...
export declare enum KnownLocalDNSQueryLogging {
...
export declare enum KnownLocalDNSProtocol {
...
export declare enum KnownLocalDNSForwardDestination {
...
export declare enum KnownLocalDNSForwardPolicy {
...
export declare enum KnownLocalDNSServeStale {
...
export declare enum KnownAdvancedNetworkPolicies {
