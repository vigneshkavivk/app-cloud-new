...
const listOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion, Parameters.expand, Parameters.top, Parameters.orderby],
    urlParameters: [
        Parameters.$host,
        Parameters.subscriptionId,
        Parameters.location,
...
const listWithPropertiesOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion, Parameters.top, Parameters.orderby, Parameters.expand4],
    urlParameters: [
        Parameters.$host,
        Parameters.subscriptionId,
        Parameters.location,
