...
const module = moduleList.find(m => m.id === moduleId);
  ...
  <>
    ...
    <div className="dashboard-root">
      ...
      {/* Main Content Area — matches your requested layout */}
      <div className="min-h-screen p-4 sm:p-6 md:p-8 lg:ml-64">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-[#1a1f2b] to-[#151924] p-6 sm:p-8 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.6)] card-glow">
            {renderStepContent()}
              ...
              <div className="flex justify-between mt-10 pt-6 border-t border-gray-800/50">
                ...
                {currentStep !== 2 && (
                  <button
                    ...
                    className={`flex items-center gap-3 py-2.5 px-6 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-[1.03] active:scale-[0.98] shadow-lg ${
