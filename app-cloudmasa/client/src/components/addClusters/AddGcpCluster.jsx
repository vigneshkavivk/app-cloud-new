  ...
  useEffect(() => {
    const loadAccounts = async () => {
      ...
      try {
        ...
        // ✅ Assume all accounts from /api/gcp/accounts are GCP accounts
        setAccounts(data); // ← Just use all data
        if (data.length === 1) {
                ...
                {selectedAccount && (
                  <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-5 border border-gray-700 card-glow">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h2 className="font-semibold red-orange-gradient-text">Project Summary</h2>
                    </div>
